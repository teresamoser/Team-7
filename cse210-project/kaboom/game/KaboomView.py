...
class KaboomView(arcade.View):
    ...
    def setup(self):
        ...
        # we use a loop to create a whole bunch of brick tiles to go in the
        # background.
        # Author: Teresa Moser
        for x in range(0, 800, 128):
            for y in range(0, 725, 128):
    ...
    def spawn_bomb(self):
        # this is the initial appearance of the bombs and the sound it makes
        # Author: Teresa Moser 
        sounda = arcade.Sound(":resources:sounds/fall1.wav") 
        sounda.play() 
